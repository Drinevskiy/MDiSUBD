...
CREATE TABLE "PROD_SCHEMA"."TST_C1" 
  ...
  TABLESPACE "USERS"  ENABLE, 
	 ...
	 CONSTRAINT "FK_C2_ID" FOREIGN KEY ("ID1")

	  REFERENCES "PROD_SCHEMA"."TST_C2" ("ID") ENABLE
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS"  ENABLE, 
	 ...
	 FOREIGN KEY ("ID2")
	  ...
	  REFERENCES "PROD_SCHEMA"."TST_C1" ("ID") ENABLE
...
alter table PROD_SCHEMA.TASKTYPE drop column TASKTYPEOTHERINFO



  CREATE TABLE "PROD_SCHEMA"."NEWTABLE" 

   (	"NEWID" NUMBER(*,0) NOT NULL ENABLE, 

	"NEWVALUE" VARCHAR2(255) NOT NULL ENABLE, 
...
alter table PROD_SCHEMA.MYTABLE drop column IMPORTANTFIELD

alter table PROD_SCHEMA.HISTORYTYPE drop column HISTORYTYPEOTHERINFO

drop function PROD_SCHEMA.GETREWARD

CREATE OR REPLACE NONEDITIONABLE PROCEDURE "PROD_SCHEMA"."I_DONT_PASS" (del_id IN NUMBER) IS
